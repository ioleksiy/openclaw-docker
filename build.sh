...
echo -e "  • ${GREEN}mcporter${NC} - Minecraft porter (via pnpm)"
echo -e "  • ${GREEN}uv${NC} - Python package installer"
echo -e "  • ${GREEN}nano-pdf${NC} - PDF processing (via uv)"
echo -e "  • ${GREEN}chromium + playwright${NC} - Browser automation"
echo -e "  • ${GREEN}openclaw CLI${NC} - Convenience wrapper"
echo ""
